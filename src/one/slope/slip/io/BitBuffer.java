...
public class BitBuffer implements Cloneable {
	...
	/**
	 * Clones bits from the input {@link BitBuffer} to the current
	 * {@link BitBuffer}.
	 * 
	...
	/**
	 * Writes a single bit (bits have only two possible values - true or false)
	 * to the backing byte array.
	 * 
	...
	/**
	 * Calculates the correct amount of bytes that encapsulates the bits
	 * written.
	 * 
	 ...
	 * 
	 * @return The amount of bytes that encapsulates the bits that have been
	 *         written.
	 */
