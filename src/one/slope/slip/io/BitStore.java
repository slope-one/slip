...
public class BitStore {
	...
	/**
	 * Sets the value of the bit flag at the specified index to the opposite of
	 * its current value.
	 * 
	 * @param index
	 *            The index of the bit flag.
	...
	/**
	 * Sets the value of the bit flag at the specified index to the specified
	 * value.
	 * 
	 * @param index
	 *            The index of the bit flag.
	 * @param value
	 *            Value of the bit flag.
	 */
